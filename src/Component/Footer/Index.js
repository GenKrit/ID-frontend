  ...
  return (
    <footer className="bg-gray-900 p-10 font-[sans-serif] tracking-wide">
          ...
          <li>
            ...
            <li>
              <motion.h5 initial="initial"
                whileInView="animate" variants={fade} className="text-gray-300 hover:text-white text-sm">+91-9651456331 / +91-8746516861</motion.h5>
            </li>
            <li>
      ...
      <div className="lg:flex lg:items-center justify-center">
        ...
        <p className='text-gray-300 text-sm mt-10'>© Handcrafted ❤ by <a href='https://github.com/GenKrit' target='_blank'
